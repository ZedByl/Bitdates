        ...
        <Box>
            ...
            <Box position={'relative'} mx={'auto'} maxW={768} md={{maxW: 1440}}>
                <Box mt={20}>
                    ...
                    <Text>Yes, users can subscribe to email notifications to receive timely updates about upcoming events in
                    ...
                    features, such as event notifications, custom calendar integration, and personalized event tracking.</Text>
                    <Heading size={'lg'}>8. Is there a fee for using the BitDates crypto events calendar?</Heading>
                    <Text>BitDates offers a free version with essential features. Advanced features, such as personalized
                        notifications and access to premium event insights, may be available through a subscription.</Text>
                    <Heading size={'lg'}>9. Does BitDates support events from all cryptocurrency projects?</Heading>
                    <Text>BitDates aims to cover events from a wide variety of cryptocurrency projects, from top market cap
                    ...
                    <Text>BitDates follows strict data security protocols, complying with industry standards for data
                        protection, and all personal data is securely stored within the European Economic Area (EEA).</Text>
                </Box>
            </Box>
        </Box>
    );
