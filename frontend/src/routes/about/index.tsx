      ...
      <Box position={'relative'} mx={'auto'} maxW={768} md={{ maxW: 1440 }}>
        <Box mt={20}>
          ...
          <Text>
            ...
            other significant occasions. Each user can easily browse upcoming
            events, add them to their personal calendar, and subscribe to
            updates to receive timely information directly to their email.
          </Text>
        </Box>
      </Box>
    </Box>
